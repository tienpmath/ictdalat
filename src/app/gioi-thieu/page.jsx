...
export const metadata = {
    title: 'Giới thiệu - Thiết Kế Website Chuyên Nghiệp, Chuẩn SEO Đà Lạt - Lâm Đồng',
    description: '☎️ Giới thiệu Dịch vụ Thiết kế website Đà Lạt - Lâm Đồng trọn gói chuẩn seo  2024✔️✔️ Thiết kế web bán hàng cao cấp, bảo trì trọn đời',
    openGraph: {
        title: 'Giới thiệu Thiết Kế Website Chuyên Nghiệp, Chuẩn SEO Đà Lạt - Lâm Đồng',
        description: '☎️ Giới thiệu  Dịch vụ Thiết kế website Đà Lạt - Lâm Đồng trọn gói chuẩn seo  2024✔️✔️ Thiết kế web bán hàng cao cấp, bảo trì trọn đời',
    },
                            ...
                            <div className="row justify-content-center gutter-24">
                                <div className="col-lg-4 col-md-6">
                                    <div className="services__item-three">
                                        ...
                                        <div className="services__content-three">
                                            <p>Design và lập trình các chức năng theo yêu cầu, mẫu thiết kế, code giao diện và module</p>
                                            <Link href="/contact" className="btn btn-two">Liên hệ</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="services__item-three">
                                        ...
                                        <div className="services__content-three">
                                            <p>triển khai và hướng dẫn khách hàng sử dụng</p>
                                            <Link href="/contact" className="btn btn-two">Liên hệ</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="services__item-three">
                                        ...
                                        <div className="services__content-three">
                                            <p>Hỗ trợ triển khai online, vận hành chính thức, đưa doanh nghiệp của bạn ra toàn cầu</p>
                                            <Link href="/contact" className="btn btn-two">Liên hệ</Link>
                                        </div>
                                    </div>
                                </div>
