                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-7">
                            <div className="section-title text-center mb-50 tg-heading-subheading animation-style3">
                                <span className="sub-title">ICT ĐÀ LẠT - DỊCH VỤ THIẾT KẾ WEBSITE CHUYÊN NGHIỆP</span>
                                <h2 className="title tg-element-title">DỊCH VỤ CỦA CHÚNG TÔI</h2>
                                <p className="tg-element-title">QUẢN TRỊ WEBSITE DỄ DÀNG VÀ VẬN HÀNH DOANH NGHIỆP THÔNG MINH <br />
                                    Tích hợp chuyển đổi số cho doanh nghiệp nhỏ và vừa, chi phí thấp, tối ưu hiệu suất.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row justify-content-center gutter-24">
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="services__item-five">
                                    ...
                                    <div className="services__content-five">
                                        <h2 className="title"><Link href="/contact">Thiết kế website</Link></h2>
                                        <p>Thiết kế web với giao diện đẹp, công nghệ mới, siêu nhanh, độc đáo, sáng tạo. Hệ thống tính năng website đầy đủ, dễ dàng quản lý, cập nhật tin bài, sản phẩm</p>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="services__item-five">
                                    ...
                                    <div className="services__content-five">
                                        <h2 className="title"><Link href="/contact">Quản trị chăm sóc website</Link></h2>
                                        <p>Giúp khách hàng cập nhật nội dung và thiết kế hình ảnh theo  yêu cầu, hướng dẫn chi tiết vận hành, bảo trì trọn đời</p>
                                        <Link href="/services-details" className="btn">Liên hệ</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="services__item-five">
                                    ...
                                    <div className="services__content-five">
                                        <h2 className="title"><Link href="/contact">Dịch vụ SEO</Link></h2>
                                        <p>Thiết kế web chuẩn SEO, đảm bảo đáp ứng các tiêu chí chuẩn SEO google</p>
                                        <Link href="/contact" className="btn">Liên hệ</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="services__item-five">
                                    ...
                                    <div className="services__content-five">
                                        <h2 className="title"><Link href="/contact">Hosting, server</Link></h2>
                                        <p>Chúng tôi cung cấp sẵn hệ thống VPS, Hosting, chi phí chỉ 1tr5/năm, hỗ trợ sao lưu data miễn phí, fix lỗi theo yêu cầu</p>
                                        <Link href="/contact" className="btn">Liên hệ</Link>
                                    </div>
                                </div>
                            </div>
