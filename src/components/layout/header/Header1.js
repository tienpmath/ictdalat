                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <ul className="tg-header__top-info left-side list-wrap">
                                    <li><i className="flaticon-phone-call" /><Link href="tel:0944838788">0944838788</Link></li>
                                    <li><i className="flaticon-pin" />Thành phố Đà Lạt, Bảo Lộc, Lâm Đồng</li>
                                </ul>
                            </div>
                            <div className="col-lg-6">
                                <ul className="tg-header__top-right list-wrap">
                                    <li><i className="flaticon-envelope" /><Link href="mailto:tiendev88@gmail.com">tiendev88@gmail.com</Link></li>
                                    <li><i className="flaticon-time" />Thứ 2 - Thứ 7: from 7h00 AM - 18h00 PM</li>
                                </ul>
                            </div>
                        </div>
                    </div>
